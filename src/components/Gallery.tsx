        ...
        >
          ...
          <div className="absolute top-4 right-4 z-[110] flex gap-4">
            <button 
              ...
              className="text-white/80 hover:text-white bg-black/30 hover:bg-black/50 p-3 rounded-full transition-colors backdrop-blur-md"
          ...
          <button 
            onClick={prevImage}
            className="absolute left-4 top-1/2 -translate-y-1/2 text-white/80 hover:text-white bg-black/30 hover:bg-black/50 p-3 rounded-full transition-colors z-[110] backdrop-blur-md"
          >
          ...
          <div className="relative max-w-[90vw] max-h-[90vh]" onClick={(e) => e.stopPropagation()}>
            ...
            />
            <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 text-white/80 font-serif tracking-widest text-sm flex gap-4 items-center">
          ...
          <button 
            onClick={nextImage}
            className="absolute right-4 top-1/2 -translate-y-1/2 text-white/80 hover:text-white bg-black/30 hover:bg-black/50 p-3 rounded-full transition-colors z-[110] backdrop-blur-md"
          >
