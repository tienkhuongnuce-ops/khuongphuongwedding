    ...
    <section className="relative w-full h-screen min-h-[700px] flex items-center justify-center overflow-hidden bg-gray-900">
      ...
      <div className="relative z-10 text-center text-white px-4 w-full max-w-5xl animate-fade-in flex flex-col items-center gap-6">
        ...
        <div className="mt-4 flex flex-col items-center gap-3">
             <div className="text-xl md:text-3xl font-serif tracking-widest text-white border-y border-white/50 py-3 px-8 backdrop-blur-sm bg-white/5 shadow-sm">
                {displayDate}
             </div>
             <p className="text-sm md:text-lg font-light tracking-wider uppercase text-white/80 mt-2 text-shadow">
                {date.dayOfWeek}
             </p>
        </div>
      </div>
