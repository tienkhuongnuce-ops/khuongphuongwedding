  ...
  return (
    <section className="relative w-full h-screen min-h-[700px] flex items-center justify-center overflow-hidden bg-gray-900">
      ...
      <div className="relative z-10 text-center text-white px-4 w-full max-w-5xl animate-fade-in flex flex-col items-center gap-6">
        ...
        {/* Top Tagline */}
        <div className="mb-2">
            <span className="text-xs md:text-sm uppercase tracking-[0.4em] text-white border-b border-white pb-3">
                Save The Date
            </span>
        </div>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-2 md:gap-8 my-4">
            ...
            <span className="font-serif text-3xl md:text-5xl text-white italic font-light">&</span>
            <h1 className="font-names text-6xl md:text-8xl lg:text-9xl text-white drop-shadow-lg">
                {bride.firstName}
            </h1>
        </div>
        ...
        <div className="mt-4 flex flex-col items-center gap-3">
             <div className="text-xl md:text-3xl font-serif tracking-widest text-white border-y border-white py-3 px-8 backdrop-blur-sm bg-white/5">
                {displayDate}
             </div>
             <p className="text-sm md:text-lg font-light tracking-wider uppercase text-white mt-2">
                {date.dayOfWeek}
             </p>
        </div>
      </div>
      ...
      <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 z-20 animate-bounce cursor-pointer">
        <a href="#invitation" className="flex flex-col items-center gap-2 text-white hover:text-gray-200 transition-colors">
