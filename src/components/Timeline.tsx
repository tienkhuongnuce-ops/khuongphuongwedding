  ...
  return (
    <section className="py-24 bg-white relative">
      <div className="max-w-4xl mx-auto px-4">
        ...
        {/* Tabs for Groom/Bride timeline */}
        {!Array.isArray(timeline) && (
            <div className="flex justify-center mb-12">
                <div className="flex bg-wedding-cream p-1 rounded-full relative border border-wedding-gold/20">
                    <button 
                        onClick={() => setActiveTab('groom')}
                        className={`px-6 py-2 rounded-full font-serif font-bold transition-all duration-300 ${
                            activeTab === 'groom' 
                            ? 'bg-wedding-red text-white shadow-md' 
                            : 'text-gray-500 hover:text-wedding-red'
                        }`}
                    >
                        Nhà Trai
                    </button>
